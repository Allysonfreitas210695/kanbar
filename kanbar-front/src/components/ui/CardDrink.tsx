...
function CardDrink({ drink }: CardDrinkProps) {
  return (
    <div className="bg-[#f7f7f7] w-[300px] h-[400px] rounded-xl shadow-lg p-4 flex flex-col items-center transition-transform duration-200 hover:scale-105 cursor-pointer mx-auto">
      <img
      ...
      <div className="flex items-center justify-between w-full mt-auto pt-2">
        ...
        <span className="text-sm text-gray-800">{'$'.repeat(drink.price)}</span>
      </div>
    </div>
  );
}
